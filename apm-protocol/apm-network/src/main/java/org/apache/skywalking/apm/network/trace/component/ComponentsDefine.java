...
public class ComponentsDefine {
    ...
    public static final OfficialComponent TOMCAT_JDBC = new OfficialComponent(152, "tomcat-jdbc");

    public static final OfficialComponent MYCAT = new OfficialComponent(153, "MyCat");
}
